...
/**
 * Remove --in-details class from all movie items.
 *
 * This function is used to toggle --in-details class from all
 * movie items, which is used to show the details section of
 * the selected movie item.
 */
